import{r as p,u as I,j as i,g as ne,R as ie}from"./react-vendor-D0Dg9dgZ.js";const Z=p.createContext(null);function Fe(){const e=p.useContext(Z);if(!e)throw new Error("useConfirm must be used inside ConfirmDialogProvider");return e}function Ve({children:e}){const{t:a}=I("common"),[t,o]=p.useState(null),s=p.useRef(null),d=p.useCallback(h=>new Promise(u=>{s.current=u,o(h)}),[]),c=p.useCallback(h=>{var u;(u=s.current)==null||u.call(s,h),s.current=null,o(null)},[]);return p.useEffect(()=>{if(!t)return;const h=u=>{u.key==="Escape"&&c(!1),u.key==="Enter"&&c(!0)};return window.addEventListener("keydown",h),()=>window.removeEventListener("keydown",h)},[t,c]),i.jsxs(Z.Provider,{value:{confirm:d},children:[e,t&&i.jsx("div",{className:"modal-overlay",onClick:()=>c(!1),children:i.jsxs("div",{className:"modal glass",onClick:h=>h.stopPropagation(),style:{maxWidth:420},children:[i.jsx("h3",{style:{marginBottom:t.message?8:24,fontSize:16},children:t.title}),t.message&&i.jsx("p",{style:{fontSize:13,color:"var(--text-secondary)",marginBottom:24,lineHeight:1.6},children:t.message}),i.jsxs("div",{style:{display:"flex",gap:8,justifyContent:"flex-end"},children:[i.jsx("button",{className:"btn btn-ghost",onClick:()=>c(!1),children:a("buttons.cancel")}),i.jsx("button",{className:`btn ${t.danger!==!1?"btn-danger":"btn-primary"}`,onClick:()=>c(!0),autoFocus:!0,children:t.confirmLabel??a("buttons.confirm")})]})]})})]})}const de={},G=e=>{let a;const t=new Set,o=(g,b)=>{const x=typeof g=="function"?g(a):g;if(!Object.is(x,a)){const f=a;a=b??(typeof x!="object"||x===null)?x:Object.assign({},a,x),t.forEach(v=>v(a,f))}},s=()=>a,u={setState:o,getState:s,getInitialState:()=>k,subscribe:g=>(t.add(g),()=>t.delete(g)),destroy:()=>{(de?"production":void 0)!=="production"&&console.warn("[DEPRECATED] The `destroy` method will be unsupported in a future version. Instead use unsubscribe function returned by subscribe. Everything will be garbage-collected if store is garbage-collected."),t.clear()}},k=a=e(o,s,u);return u},ce=e=>e?G(e):G;var K={exports:{}},X={},Q={exports:{}},Y={};/**
 * @license React
 ...
 */var w=p;function le(e,a){return e===a&&(e!==0||1/e===1/a)||e!==e&&a!==a}var ye=typeof Object.is=="function"?Object.is:le,he=w.useState,ue=w.useEffect,pe=w.useLayoutEffect,ge=w.useDebugValue;function me(e,a){var t=a(),o=he({inst:{value:t,getSnapshot:a}}),s=o[0].inst,d=o[1];return pe(function(){s.value=t,s.getSnapshot=a,J(s)&&d({inst:s})},[e,t,a]),ue(function(){return J(s)&&d({inst:s}),e(function(){J(s)&&d({inst:s})})},[e]),ge(t),t}function J(e){var a=e.getSnapshot;e=e.value;try{var t=a();return!ye(e,t)}catch{return!0}}function fe(e,a){return a()}var ke=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?fe:me;Y.useSyncExternalStore=w.useSyncExternalStore!==void 0?w.useSyncExternalStore:ke;Q.exports=Y;var xe=Q.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Le=p.forwardRef(({color:e="currentColor",size:a=24,strokeWidth:t=2,absoluteStrokeWidth:o,className:s="",children:d,iconNode:c,...h},u)=>p.createElement("svg",{ref:u,...De,width:a,height:a,stroke:e,strokeWidth:o?Number(t)*24/Number(a):t,className:ae("lucide",s),...h},[...c.map(([k,g])=>p.createElement(k,g)),...Array.isArray(d)?d:[d]]));/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const n=(e,a)=>{const t=p.forwardRef(({className:o,...s},d)=>p.createElement(Le,{ref:d,iconNode:a,className:ae(`lucide-${Je(e)}`,o),...s}));return t.displayName=`${e}`,t};/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const st=n("ChevronLeft",[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Tt=n("Key",[["path",{d:"m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4",key:"g0fldk"}],["path",{d:"m21 2-9.6 9.6",key:"1j0ho8"}],["circle",{cx:"7.5",cy:"15.5",r:"5.5",key:"yqb3hr"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Jt=n("MapPin",[["path",{d:"M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z",key:"2oe9fu"}],["circle",{cx:"12",cy:"10",r:"3",key:"ilqhr7"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Dt=n("Monitor",[["rect",{width:"20",height:"14",x:"2",y:"3",rx:"2",key:"48i651"}],["line",{x1:"8",x2:"16",y1:"21",y2:"21",key:"1svkeh"}],["line",{x1:"12",x2:"12",y1:"17",y2:"21",key:"vw1qmm"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Bt=n("Play",[["polygon",{points:"6 3 20 12 6 21 6 3",key:"1oa8hb"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oa=n("SlidersHorizontal",[["line",{x1:"21",x2:"14",y1:"4",y2:"4",key:"obuewd"}],["line",{x1:"10",x2:"3",y1:"4",y2:"4",key:"1q6298"}],["line",{x1:"21",x2:"12",y1:"12",y2:"12",key:"1iu8h1"}],["line",{x1:"8",x2:"3",y1:"12",y2:"12",key:"ntss68"}],["line",{x1:"21",x2:"16",y1:"20",y2:"20",key:"14d8ph"}],["line",{x1:"12",x2:"3",y1:"20",y2:"20",key:"m0wm8r"}],["line",{x1:"14",x2:"14",y1:"2",y2:"6",key:"14e1ph"}],["line",{x1:"8",x2:"8",y1:"10",y2:"14",key:"1i6ji0"}],["line",{x1:"16",x2:"16",y1:"18",y2:"22",key:"1lctlv"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const sa=n("Square",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const va=n("ZoomOut",[["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}],["line",{x1:"21",x2:"16.65",y1:"21",y2:"16.65",key:"13gj7c"}],["line",{x1:"8",x2:"14",y1:"11",y2:"11",key:"durymu"}]]),_=new Map,j=new Map,V={unraid_status:2e3,appdata_backup:6e5,weather:6e5,pollen:6e5},qe=R((e,a)=>({widgets:[],stats:{},loading:!1,loadWidgets:async()=>{e({loading:!0});try{const t=await l.widgets.list();e({widgets:t})}finally{e({loading:!1})}},createWidget:async t=>{const o=await l.widgets.create(t);return e(s=>({widgets:[...s.widgets,o]})),o.id},updateWidget:async(t,o)=>{const s=await l.widgets.update(t,o);e(d=>({widgets:d.widgets.map(c=>c.id===t?s:c)}))},deleteWidget:async t=>{await l.widgets.delete(t),e(o=>({widgets:o.widgets.filter(s=>s.id!==t),stats:Object.fromEntries(Object.entries(o.stats).filter(([s])=>s!==t))}))},uploadWidgetIcon:async(t,o,s)=>{const{icon_url:d}=await l.widgets.uploadIcon(t,o,s);e(c=>({widgets:c.widgets.map(h=>h.id===t?{...h,icon_url:d}:h)}))},loadStats:async t=>{try{const o=await l.widgets.stats(t);e(s=>({stats:{...s.stats,[t]:o}}))}catch{}},setAdGuardProtection:async(t,o)=>{await l.widgets.setAdGuardProtection(t,o),await a().loadStats(t)},triggerButton:async(t,o)=>{await l.widgets.triggerButton(t,o)},haToggle:async(t,o,s)=>{await l.widgets.haToggle(t,o,s),await a().loadStats(t),setTimeout(()=>a().loadStats(t).catch(()=>{}),2e3)},setPiholeProtection:async(t,o)=>{await l.widgets.setPiholeProtection(t,o),await a().loadStats(t)},startPolling:(t,o)=>{const s=(j.get(t)??0)+1;if(j.set(t,s),s===1){const d=V[o]??3e4;o in V||console.warn(`[useWidgetStore] Unknown widget type "${o}" — using default 30s interval`);const c=setInterval(()=>{qe.getState().loadStats(t).catch(()=>{})},d);_.set(t,c)}},stopPolling:t=>{const o=(j.get(t)??1)-1;if(o<=0){const s=_.get(t);s!==void 0&&clearInterval(s),_.delete(t),j.delete(t)}else j.set(t,o)},startPollingAll:t=>{t.forEach(o=>a().startPolling(o.id,o.type))},stopPollingAll:()=>{[..._.keys()].forEach(o=>a().stopPolling(o))}})),Sa=R((e,a)=>({groups:[],items:[],loading:!1,editMode:!1,showVisibilityOverlay:!1,loadDashboard:async()=>{e({loading:!0});try{const{groups:t,items:o}=await l.dashboard.list();e({groups:t,items:o,loading:!1})}catch{e({loading:!1})}},setEditMode:t=>e({editMode:t}),setShowVisibilityOverlay:t=>e({showVisibilityOverlay:t}),addServiceItem:async t=>{await l.dashboard.addItem("service",t),await a().loadDashboard()},addWidgetItem:async t=>{await l.dashboard.addItem("widget",t),await a().loadDashboard()},addPlaceholder:async t=>{await l.dashboard.addItem(t),await a().loadDashboard()},removeItem:async t=>{await l.dashboard.removeItem(t),await a().loadDashboard()},removeByRef:async(t,o)=>{await l.dashboard.removeByRef(t,o),await a().loadDashboard()},reorder:async t=>{await l.dashboard.reorder(t),await a().loadDashboard()},createGroup:async t=>{await l.dashboard.createGroup(t),await a().loadDashboard()},updateGroup:async(t,o)=>{await l.dashboard.updateGroup(t,o),await a().loadDashboard()},deleteGroup:async t=>{await l.dashboard.deleteGroup(t),await a().loadDashboard()},reorderGroups:async t=>{await l.dashboard.reorderGroups(t),await a().loadDashboard()},moveItemToGroup:async(t,o)=>{await l.dashboard.moveItemToGroup(t,o),await a().loadDashboard()},reorderGroupItems:async(t,o)=>{await l.dashboard.reorderGroupItems(t,o),await a().loadDashboard()}}));function wa({iconId:e,iconUrl:a,onChange:t}){const{t:o}=I("common"),[s,d]=p.useState(!1),[c,h]=p.useState("search"),[u,k]=p.useState(""),[g,b]=p.useState([]),[x,f]=p.useState(!1),[v,O]=p.useState(null),[A,P]=p.useState(null),[H,$]=p.useState(null),U=p.useRef(null),z=p.useRef(null),C=e?`/api/icons/${e}`:a;p.useEffect(()=>{s||(k(""),b([]),P(null),$(null))},[s]);const re=y=>{if(k(y),z.current&&clearTimeout(z.current),!y.trim()){b([]);return}z.current=setTimeout(async()=>{f(!0),P(null);try{const m=await l.icons.search(y.trim());b(m.icons)}catch(m){P(m instanceof Error?m.message:o("icon_picker.error_search"))}finally{f(!1)}},300)},oe=async y=>{O(y.name);try{const m=await l.icons.download(y.name);t(m.id),d(!1)}catch(m){P(m instanceof Error?m.message:o("icon_picker.error_download"))}finally{O(null)}},q=async y=>{if(y.size>512*1024){$(o("icon_picker.error_too_large"));return}if(!["image/png","image/jpeg","image/svg+xml","image/webp"].includes(y.type)){$(o("icon_picker.error_unsupported"));return}$(null);const S=new FileReader;S.onload=async()=>{const se=S.result.split(",")[1];try{const E=await l.icons.upload(se,y.type,y.name.replace(/\.[^.]+$/,""));t(E.id),d(!1)}catch(E){$(E instanceof Error?E.message:o("icon_picker.error_upload"))}},S.readAsDataURL(y)};return i.jsxs(i.Fragment,{children:[i.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[C?i.jsx("div",{style:{width:40,height:40,borderRadius:"var(--radius-sm)",border:"1px solid var(--glass-border)",background:"var(--glass-bg)",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",flexShrink:0},children:i.jsx("img",{src:C,alt:"",style:{width:32,height:32,objectFit:"contain"}})}):i.jsx("div",{style:{width:40,height:40,borderRadius:"var(--radius-sm)",border:"1px solid var(--glass-border)",background:"var(--glass-bg)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0},children:i.jsx(Re,{size:16,style:{color:"var(--text-muted)"}})}),i.jsx("button",{type:"button",className:"btn btn-ghost btn-sm",onClick:()=>d(!0),style:{gap:4},children:o(C?"icon_picker.change":"icon_picker.choose")}),C&&i.jsx("button",{type:"button",className:"btn btn-ghost btn-sm",onClick:()=>t(null),style:{color:"var(--text-muted)",padding:"4px 8px"},children:i.jsx(F,{size:12})})]}),s&&i.jsx("div",{className:"modal-overlay",onClick:y=>{y.target===y.currentTarget&&d(!1)},style:{zIndex:1100},children:i.jsxs("div",{className:"glass modal",style:{width:"100%",maxWidth:560,maxHeight:"80vh",display:"flex",flexDirection:"column"},onClick:y=>y.stopPropagation(),children:[i.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"20px 20px 0"},children:[i.jsx("h3",{style:{margin:0,fontFamily:"var(--font-display)",fontSize:16},children:o("icon_picker.modal_title")}),i.jsx("button",{className:"btn btn-ghost btn-icon",onClick:()=>d(!1),children:i.jsx(F,{size:16})})]}),i.jsx("div",{style:{display:"flex",gap:4,padding:"12px 20px 0"},children:["search","upload"].map(y=>i.jsx("button",{type:"button",className:`btn btn-sm ${c===y?"btn-primary":"btn-ghost"}`,onClick:()=>h(y),style:{fontSize:12},children:o(y==="search"?"icon_picker.tab_search":"icon_picker.tab_upload")},y))}),i.jsxs("div",{style:{flex:1,overflow:"hidden",display:"flex",flexDirection:"column",padding:"12px 20px 20px"},children:[c==="search"&&i.jsxs(i.Fragment,{children:[i.jsxs("div",{style:{position:"relative",marginBottom:12},children:[i.jsx(He,{size:14,style:{position:"absolute",left:10,top:"50%",transform:"translateY(-50%)",color:"var(--text-muted)",pointerEvents:"none"}}),i.jsx("input",{className:"form-input",style:{paddingLeft:32},placeholder:o("icon_picker.search_placeholder"),value:u,onChange:y=>re(y.target.value),autoFocus:!0})]}),A&&i.jsx("div",{style:{color:"var(--status-offline)",fontSize:12,marginBottom:8},children:A}),i.jsxs("div",{style:{flex:1,overflowY:"auto"},children:[x&&i.jsx("div",{style:{display:"flex",justifyContent:"center",padding:20},children:i.jsx("div",{className:"spinner",style:{width:20,height:20,borderWidth:2}})}),!x&&!u.trim()&&i.jsx("div",{style:{textAlign:"center",padding:"32px 0",color:"var(--text-muted)",fontSize:13},children:o("icon_picker.search_hint")}),!x&&u.trim()&&g.length===0&&!A&&i.jsx("div",{style:{textAlign:"center",padding:"32px 0",color:"var(--text-muted)",fontSize:13},children:o("icon_picker.no_results",{query:u})}),!x&&g.length>0&&i.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(72px, 1fr))",gap:8},children:g.map(y=>i.jsxs("button",{type:"button",className:"icon-picker-item",onClick:()=>oe(y),disabled:v===y.name,title:y.name,children:[v===y.name?i.jsx("div",{className:"spinner",style:{width:16,height:16,borderWidth:2}}):i.jsx("img",{src:y.preview_url,alt:y.name,loading:"lazy",style:{width:36,height:36,objectFit:"contain"}}),i.jsx("span",{style:{fontSize:10,color:"var(--text-muted)",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",width:"100%",textAlign:"center"},children:y.name})]},y.name))})]})]}),c==="upload"&&i.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:12},children:[H&&i.jsx("div",{style:{color:"var(--status-offline)",fontSize:12},children:H}),i.jsxs("div",{className:"icon-picker-dropzone",onClick:()=>{var y;return(y=U.current)==null?void 0:y.click()},onDragOver:y=>y.preventDefault(),onDrop:y=>{y.preventDefault();const m=y.dataTransfer.files[0];m&&q(m)},children:[i.jsx(Ue,{size:24,style:{color:"var(--text-muted)",marginBottom:8}}),i.jsx("div",{style:{fontSize:13,color:"var(--text-secondary)"},children:o("icon_picker.dropzone_label")}),i.jsx("div",{style:{fontSize:11,color:"var(--text-muted)",marginTop:4},children:o("icon_picker.dropzone_hint")})]}),i.jsx("input",{ref:U,type:"file",accept:"image/png,image/jpeg,image/svg+xml,image/webp",style:{display:"none"},onChange:y=>{var S;const m=(S=y.target.files)==null?void 0:S[0];m&&q(m)}})]})]})]})})]})}const Ge={0:"☀️",1:"🌤️",2:"⛅",3:"☁️",45:"🌫️",48:"🌫️",51:"🌦️",53:"🌦️",55:"🌦️",61:"🌧️",63:"🌧️",65:"🌧️",71:"🌨️",73:"🌨️",75:"🌨️",77:"🌨️",80:"🌦️",81:"🌦️",82:"🌧️",85:"🌨️",86:"🌨️",95:"⛈️",96:"⛈️",99:"⛈️"};function Oa({stats:e,config:a}){const{t}=I("widgets");if(e.error)return i.jsx("div",{style:{fontSize:12,color:"var(--status-offline)"},children:e.error});const o=t(`weather.codes.${e.weather_code}`,`Code ${e.weather_code}`),s=Ge[e.weather_code]??"🌡️",d=a.location_name||null;return i.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:10},children:[d&&i.jsxs("div",{style:{fontSize:11,color:"var(--text-muted)",display:"flex",alignItems:"center",gap:4},children:[i.jsx(Ie,{size:11}),d]}),i.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10},children:[i.jsx("span",{style:{fontSize:40,lineHeight:1,flexShrink:0},children:s}),i.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:2},children:[i.jsxs("span",{style:{fontSize:32,fontWeight:700,fontFamily:"var(--font-mono)",color:"var(--accent)",lineHeight:1},children:[e.temperature,e.unit]}),i.jsx("span",{style:{fontSize:12,color:"var(--text-secondary)"},children:o})]})]}),i.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6,fontSize:12},children:[i.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:2},children:[i.jsx("span",{style:{color:"var(--text-muted)",fontSize:10},children:t("weather.feels_like")}),i.jsxs("span",{style:{fontFamily:"var(--font-mono)",fontWeight:500},children:[e.apparent_temperature,e.unit]})]}),i.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:2},children:[i.jsx("span",{style:{color:"var(--text-muted)",fontSize:10},children:t("weather.humidity")}),i.jsxs("span",{style:{fontFamily:"var(--font-mono)",fontWeight:500},children:[e.humidity,"%"]})]}),i.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:2},children:[i.jsx("span",{style:{color:"var(--text-muted)",fontSize:10},children:t("weather.wind")}),i.jsxs("span",{style:{fontFamily:"var(--font-mono)",fontWeight:500},children:[e.wind_speed," km/h"]})]}),e.precipitation>0&&i.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:2},children:[i.jsx("span",{style:{color:"var(--text-muted)",fontSize:10},children:t("weather.precipitation")}),i.jsxs("span",{style:{fontFamily:"var(--font-mono)",fontWeight:500},children:[e.precipitation," mm"]})]})]})]})}function L(e){return e==null?"var(--text-muted)":e>=5?"var(--status-offline)":e>=3?"#f59e0b":e>=1?"var(--accent)":"var(--text-muted)"}function $a({stats:e}){if(!e||e.error)return i.jsx("div",{style:{fontSize:12,color:"var(--text-muted)",textAlign:"center",padding:"8px 0"},children:(e==null?void 0:e.error)||"Pollen aktuell nicht verfügbar"});const a=[{label:"Hasel",level:e.hasel,text:e.hasel_text},{label:"Birke",level:e.birke,text:e.birke_text},{label:"Gräser",level:e.graeser,text:e.graeser_text},...e.pappel_text||e.pappel!=null?[{label:"Pappel",level:e.pappel,text:e.pappel_text}]:[]];return i.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[i.jsxs("div",{style:{display:"flex",justifyContent:"space-between",gap:8,alignItems:"baseline"},children:[i.jsx("div",{style:{fontSize:12,fontWeight:600},children:e.source_region||"Pollen"}),i.jsx("div",{style:{fontSize:10,color:"var(--text-muted)"},children:e.updated_at?new Date(e.updated_at).toLocaleDateString("de-DE"):""})]}),a.map(t=>i.jsxs("div",{style:{display:"flex",justifyContent:"space-between",gap:10,alignItems:"center",fontSize:12},children:[i.jsx("div",{style:{color:"var(--text-secondary)"},children:t.label}),i.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,minWidth:0},children:[i.jsx("span",{style:{color:L(t.level),fontWeight:600,textAlign:"right"},children:t.text||"—"}),i.jsx("span",{title:t.text||"—",style:{width:10,height:10,borderRadius:"50%",background:L(t.level),boxShadow:`0 0 6px ${L(t.level)}66`,flexShrink:0}})]})]},t.label))]})}export{ma as $,Qe as A,Ut as B,ut as C,mt as D,kt as E,He as F,wt as G,dt as H,Re as I,nt as J,at as K,zt as L,Jt as M,Xe as N,$t as O,qt as P,na as Q,Kt as R,ta as S,ya as T,Ue as U,ka as V,fa as W,F as X,xt as Y,xa as Z,tt as _,l as a,ga as a0,Ae as a1,wa as a2,Zt as a3,ht as a4,ha as a5,ct as a6,Qt as a7,Xt as a8,pt as a9,lt as aA,Wt as aB,Ct as aC,Ye as aD,Ze as aE,sa as aa,Lt as ab,It as ac,vt as ad,Dt as ae,jt as af,Ot as ag,Tt as ah,ia as ai,pa as aj,qe as ak,Pt as al,oa as am,st as an,Ke as ao,Sa as ap,Ve as aq,Fe as ar,Oa as as,$a as at,Mt as au,ea as av,et as aw,Rt as ax,ft as ay,_t as az,At as b,R as c,Nt as d,aa as e,Ht as f,Bt as g,ra as h,ot as i,it as j,la as k,ca as l,bt as m,da as n,ba as o,va as p,Vt as q,yt as r,Et as s,Gt as t,Ft as u,gt as v,St as w,ua as x,Yt as y,rt as z};
